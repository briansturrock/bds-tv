...
DIAGNOSTIC_ENDPOINTS: list[dict[str, Any]] = [
    ...
    endpoint(category="HDHR", name="Save HDHR settings", method="POST", path="/api/hdhr/settings", description="Saves HDHomeRun emulation settings.", sample_body={"enabled": False, "device_name": "iptv-epg", "device_id": "12345678", "tuner_count": 1, "max_upstream_streams": 1, "public_base_url": "http://192.168.0.185:8088", "stream_mode": "direct", "conflict_policy": "reject_new", "ffmpeg_path": "ffmpeg"}),
